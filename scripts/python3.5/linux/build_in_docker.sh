...
export ORGANREGEN_ENGINE_BRANCH_OR_TAG="${ORGANREGEN_ENGINE_BRANCH_OR_TAG:-master}"
...
export CURA_ENABLE_ORGANREGEN_ENGINE_EXTRA_OPTIMIZATION_FLAGS="${CURA_ENABLE_ORGANREGEN_ENGINE_EXTRA_OPTIMIZATION_FLAGS:-ON}"
