...
!macro RegisterExtensionCall _EXECUTABLE _EXTENSION _APPNAME _DESCRIPTION
  !verbose push
  !verbose ${_FileAssociation_VERBOSE}
  Push `${_DESCRIPTION}`
  Push `${_APPNAME}`
...
;NoBackup:
  ...
  StrCmp $0 "" 0 Skip
    ...
    WriteRegStr HKCR "$R1\DefaultIcon" "" "$R3,0"
Skip:
...
; Uncomment if you want a "Slice with Organ Regenerator".. Oh my god!
;  WriteRegStr HKCR "$R1\shell\slice" "" "Slice with Organ Regenerator"
