...
add_custom_command(
    TARGET signing PRE_BUILD
    COMMAND codesign -s ${OSX_CODESIGN_IDENTITY} --deep "Organ Regenerator.app"
    WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/build
)

install(DIRECTORY "${CMAKE_BINARY_DIR}/build/Organ Regenerator.app" DESTINATION "." USE_SOURCE_PERMISSIONS)
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Organ Regenerator 3D Printing Software")
